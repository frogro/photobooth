    ...
    public static function getNode(): NodeDefinition
    {
        return (new TreeBuilder('payments'))->getRootNode()
            ...
            ->children()
                ...
                ->enumNode('provider')
                    ->values(['none', 'sumup', 'coin', 'sumup_coin'])
                    ->defaultValue('none')
                ->end()
                ->enumNode('display_mode')
                    ...
                    ->defaultValue('solo')
                ->end()
                ->enumNode('payment_mode')
                    ->values(['terminal', 'qr', 'coin', 'terminal_qr', 'terminal_coin', 'qr_coin', 'terminal_qr_coin'])
                ...
                ->arrayNode('coin')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('pico_url')->defaultValue('')->end()
